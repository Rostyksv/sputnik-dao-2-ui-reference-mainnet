...
export const Proposal = (props) => {
  ...
  const vote = async (vote) => {
    try {
      ...
      await callMethod({
        ...
        method: 'act_proposal',
        args: { id: props.id, action: vote },
        gas: new Decimal('300000000000000').toString()
      });
    } catch (e) {
      console.log(e);
  ...
  const canVote = (permission) =>
    !!accountId &&
    props.daoPolicy.roles.some(
      (role) =>
        (role.kind === 'Everyone' ||
      ...
      {props.data.kind ? (
        <div className="proposal-item__container">
          ...
          >
            ...
            <MDBModalBody className="text-center">You are already voted</MDBModalBody>
            <MDBModalFooter>
              <MDBBtn className="w-100" color="info" onClick={toggleVoteWarningOff}>
                Close
              </MDBBtn>
            </MDBModalFooter>
          </MDBModal>
          ...
          <MDBCard className="mb-5 stylish-color white-text proposal-item__card">
            <MDBCardHeader className="text-center h4-responsive">
              ...
              {props.data.kind.AddMemberToRole && props.data.kind.AddMemberToRole.role === 'council'
                ? 'Add ' + props.data.kind.AddMemberToRole.member_id + ' to the council'
                : null}
              {props.data.kind.RemoveMemberFromRole &&
              props.data.kind.RemoveMemberFromRole.role === 'council'
                ? 'Remove ' + props.data.kind.RemoveMemberFromRole.member_id + ' from the council'
                : null}
              {props.data.kind.Transfer && props.data.kind.Transfer.token_id === ''
                ...
                : null}
              {metadata && props.data.kind.Transfer && props.data.kind.Transfer.token_id !== ''
                ? 'Request for payout ' +
                  props.data.kind.Transfer.token_id.split('.')[0].toUpperCase() +
              ...
              {props.data.kind === 'UpgradeRemote'
                ? 'UpgradeRemote: ' + props.data.kind.UpgradeRemote.receiver_id
                : null}
            ...
            <MDBCardBody className="white-text proposal-item__body">
              ...
              <MDBCardText className="proposal-item__text">
                ...
                {props.data.description.split('/t/')[1] ? (
                  ...
                  >
                    {'https://gov.near.org/t/' + props.data.description.split('/t/')[1]}
                  </a>
                ) : null}
                <hr />
                ...
                props.data.kind.FunctionCall.actions[0].method_name === 'create_token' &&
                JSON.parse(atob(props.data.kind.FunctionCall.actions[0].args)).args ? (
                ...
                JSON.parse(atob(props.data.kind.FunctionCall.actions[0].args)).args ? (
                  <>
                    ...
                    >
                      decimals:{' '}
                      {
                        JSON.parse(atob(props.data.kind.FunctionCall.actions[0].args)).args.metadata
                          .decimals
                      }
                    </MDBBox>
                    <MDBBox
                    ...
                    <MDBBox className="float-right h4-responsive" style={{ width: '80%' }}>
                      <a
                        ...
                        href={
                          stateCtx.config.network.explorerUrl +
                          '/accounts/' +
                          props.data.kind.UpgradeRemote.receiver_id
                        }
                        rel="noreferrer"
                      >
                        {props.data.kind.UpgradeRemote.receiver_id}
                ...
                */}
                ...
                {props.data.kind.Transfer ? (
                  <>
                    <div className="float-left text-muted h4-responsive">amount</div>
                ...
                atob(props.data.kind.FunctionCall.actions[0].args) ? (
                  <>
                    <div className="float-left text-muted h4-responsive">deposit</div>
                    <MDBBox className="float-right h4-responsive white-text">
                      {new Decimal(props.data.kind.FunctionCall.actions[0].deposit)
                        .div(yoktoNear)
                        .toString()}
                    </MDBBox>
                    <br />
                    <div className="clearfix" />
                    <div className="float-left text-muted h4-responsive">method</div>
                    <MDBBox className="float-right h4-responsive white-text">
                    ...
                    <br />
                    <div className="clearfix" />
                    <div className="float-left text-muted h4-responsive">args</div>
                    <MDBBox className="float-right h4-responsive white-text">
                ...
                <li className="list-inline-item pr-2">
                  <div>
                    ...
                    Object.values(props.data.votes).includes('Approve') ? (
                      <MDBPopover placement="top" popover clickable domElement="div" id="popover1">
              ...
              <MDBCard className="stylish-color-dark">
                <MDBCardBody className="text-left p-4 m-4 white-text">
                  ...
                  {daoPolicy && daoPolicy.roles
                    ...
                    : null}
                  <hr />
                  <MDBLink to={'/' + dao} className="elegant-color white-text text-center">
                    BACK TO DAO
                  </MDBLink>
                </MDBCardBody>
              </MDBCard>
